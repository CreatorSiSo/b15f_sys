...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_type("B15F")
        .allowlist_file("/usr/lib/avr/include/avr/sfr_defs.h")
        .allowlist_file("/usr/lib/avr/include/avr/iom1284p.h")
        ...
        .allowlist_function("B15F_getRegisterPINA")
        .allowlist_function("B15F_setRegisterDDRA")
        .allowlist_function("B15F_setRegisterPORTA")
